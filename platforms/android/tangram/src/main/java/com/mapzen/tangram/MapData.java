...
public class MapData {
    ...
    /**
     * Sets the features that will be displayed by this MapData
     * @param features The list of features to display
     */
    protected void setFeatures(List<Geometry> features) {
        map.clearTileSource(pointer);
        map.setTileSourceFeatures(pointer, features.toArray(new Geometry[features.size()]));
    }
     ...
     */
    public void setGeoJson(String data) {
        map.clearTileSource(pointer);
        map.setTileSourceGeoJson(pointer, data);
    }
