...
@interface TGMapData () {
    std::shared_ptr<Tangram::ClientTileSource> dataSource;
}
...
- (instancetype)initWithMapView:(TGMapViewController *)mapView name:(NSString *)name source:(std::shared_ptr<Tangram::ClientTileSource>)source
{
    self = [super init];
