...
extern "C" {
    ...
    JNIEXPORT void JNICALL Java_com_mapzen_tangram_MapController_handleRotateGesture(JNIEnv* jniEnv, jobject obj, jfloat posX, jfloat posY, jfloat rotation, jfloat velocity) {
        Tangram::handleRotateGesture(posX, posY, rotation, velocity);
    }
